...
POSITION_DIFF_PRINT="${POSITION_DIFF_PRINT:-all}"
POSITION_EQUAL_TOL="${POSITION_EQUAL_TOL:-1e-6}"
POSITION_DIFF_CHUNK_SIZE="${POSITION_DIFF_CHUNK_SIZE:-128}"
...
args=(
  ...
  --position-diff-print "${POSITION_DIFF_PRINT}"
  --position-equal-tol "${POSITION_EQUAL_TOL}"
  --position-diff-chunk-size "${POSITION_DIFF_CHUNK_SIZE}"
)
